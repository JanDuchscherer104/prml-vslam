...
# TODO: decide: should we maybe move the StageActor definitions into the stage specific modules? Anser: yes! Also, this is somewhat redundant with SlamSession!
