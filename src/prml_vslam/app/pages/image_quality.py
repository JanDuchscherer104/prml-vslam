...
def render(context: AppContext) -> None:
    ...
    with st.container(border=True):
        ...
        selection_state = query.resolve_selection(dataset=dataset, preferred_sequence_slug=state.sequence_slug)
        ...
        selection_state = query.resolve_selection(dataset=dataset, preferred_sequence_slug=sequence_slug)
        if not selection_state.runs:
