...
- implement thin wrappers that consume raw sequences/packets and produce
...
- Packet reading, source credits, and transport state remain internal sidecars
...
- live Record3D treats sampling as best-effort packet filtering before the SLAM hot path
