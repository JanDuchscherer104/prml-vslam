...
from .wifi_packets import Record3DWiFiMetadata, record3d_wifi_observation_from_video_frame
...
class _Record3DWiFiReceiverRuntime:
    ...
    def __init__(
        ...
        *,
        ...
        on_packet: Callable[[Observation], None],
        ...
        while not self.stop_requested():
            ...
            self.on_packet(
                record3d_wifi_observation_from_video_frame(
                    ...
                    seq=self._next_observation_seq,
