...
from .record3d.record3d_layout import (
    list_local_sequence_ids as list_local_record3d_sequence_ids,
)
from .record3d.record3d_layout import (
    resolve_existing_reference_tum as resolve_existing_record3d_reference_tum,
)
...
def list_sequence_slugs(dataset_id: DatasetId, dataset_root: Path) -> list[str]:
    ...
    match dataset_id:
        ...
        case DatasetId.RECORD3D:
            return list_local_record3d_sequence_ids(dataset_root)
...
def resolve_reference_path(dataset_id: DatasetId, dataset_root: Path, sequence_slug: str) -> Path | None:
    ...
    match dataset_id:
        ...
        case DatasetId.RECORD3D:
            return resolve_existing_record3d_reference_tum(dataset_root, sequence_slug)
        case DatasetId.TUM_RGBD:
