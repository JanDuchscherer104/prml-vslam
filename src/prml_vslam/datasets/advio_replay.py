...
from prml_vslam.io.interfaces import PinholeCameraIntrinsics, VideoFramePacket, VideoPacketStream


def wrap_with_advio_video_rotation(stream: VideoPacketStream, *, video_path: Path) -> VideoPacketStream:
