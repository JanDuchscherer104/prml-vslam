            ...
            return FramePacket(
                ...
                metadata={
                    **self.metadata,
                    ...
                    "rgb_path": str(association.rgb_path),
                    "depth_path": None if association.depth_path is None else str(association.depth_path),
                    "pose_timestamp_s": association.pose_timestamp_s,
                },
            )
