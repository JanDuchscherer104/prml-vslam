...
2. Entity tree
   - Every payload belongs to one entity path such as
     `world/slam/vista_slam_world/keyframes/points/000123/points`.
...
world/slam/vista_slam_world/live/tracking/camera  Transform3D(T_world_camera_tracking, axis_length=0)
world/slam/vista_slam_world/live/model            Transform3D(T_world_camera_live, axis_length=0)
world/slam/vista_slam_world/live/model/diag/rgb   Image(rgb_live_model_raster)  # 2D-only
world/slam/vista_slam_world/live/model/camera/image  Pinhole(K_live, resolution, camera_xyz=RDF)
world/slam/vista_slam_world/live/model/camera/image  Image(rgb_live_camera_surface)
world/slam/vista_slam_world/live/model/camera/image/depth  DepthImage(depth_live_m, meter=1.0)
world/slam/vista_slam_world/live/model/diag/preview  Image(debug_preview_live)  # only when enabled
world/slam/vista_slam_world/live/model/points     Points3D(pointmap_xyz_camera_live)  # latest/debug

world/slam/vista_slam_world/keyframes/cameras/000000  Transform3D(T_world_camera_keyframe, axis_length=0)
world/slam/vista_slam_world/keyframes/cameras/000000/image  Pinhole(K_keyframe, resolution, camera_xyz=RDF)
world/slam/vista_slam_world/keyframes/cameras/000000/image  Image(rgb_keyframe)
world/slam/vista_slam_world/keyframes/cameras/000000/image/depth  DepthImage(depth_keyframe_m, meter=1.0)
world/slam/vista_slam_world/keyframes/cameras/000000/diag/preview  Image(debug_preview_keyframe)
world/slam/vista_slam_world/keyframes/points/000000  Transform3D(T_world_camera_keyframe, axis_length=0)
world/slam/vista_slam_world/keyframes/points/000000/points  Points3D(pointmap_xyz_camera_keyframe)
...
- `world/slam/vista_slam_world/live/model/diag/rgb` is a dedicated 2D-only model RGB surface.
- `world/slam/vista_slam_world/live/model/camera/image` is the 3D camera-image entity and should only
...
- The default 3D blueprint includes `world/slam/vista_slam_world/live/model/camera/image`
...
- Camera-local pointmaps stay camera-local and inherit world placement from the
  posed parent entity.
- `world/slam/vista_slam_world/live/model/points` is mutable latest/debug geometry.
- `world/slam/vista_slam_world/keyframes/points/<id>/points` is the persistent keyed-history map
  surface and should be the default 3D geometry in the viewer.
- `world/slam/vista_slam_world/keyframes/cameras/<id>` is a frustum/history surface that may be
