...
- `.agents/references/agent_reference.md`: context7 library IDs and links to primary sources for the libraries, tools, and papers that matter most for this project.
