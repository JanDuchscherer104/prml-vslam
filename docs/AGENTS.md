...
- Use `docs/agent_reference.md` for the detailed benchmark contract and agent lookup material.
...
- When benchmark protocol language changes, sync `docs/agent_reference.md` and any affected
