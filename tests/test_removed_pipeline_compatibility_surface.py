...
_REMOVED_TOKENS = (
    ...
    "pipeline." + "stage_" + "cache",
    "pipeline." + "finalization",
    "Ground" + "Alignment" + "Runtime" + "Input",
    "Trajectory" + "Evaluation" + "Runtime" + "Input",
    "Reconstruction" + "Runtime" + "Input",
    "Summary" + "Runtime" + "Input",
    "Slam" + "Offline" + "Input",
    "Slam" + "Streaming" + "Start" + "Input",
