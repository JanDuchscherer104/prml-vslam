...
class Application:
    ...
    def quit(self) -> None:
        ...
        """
    def render_to_image(self, arg0: open3d.cuda.pybind.visualization.rendering.Open3DScene, arg1: int, arg2: int) -> open3d.cuda.pybind.geometry.Image:
        """
...
class SceneWidget(Widget):
    ...
    def set_view_controls(self, arg0: SceneWidget.Controls) -> None:
        ...
        """
    @typing.overload
    def setup_camera(self, arg0: float, arg1: open3d.cuda.pybind.geometry.AxisAlignedBoundingBox, arg2: numpy.ndarray) -> None:
        """
        Configure the camera: setup_camera(field_of_view, model_bounds, center_of_rotation)
        """
    @typing.overload
    def setup_camera(self, arg0: open3d.cuda.pybind.camera.PinholeCameraIntrinsic, arg1: numpy.ndarray, arg2: open3d.cuda.pybind.geometry.AxisAlignedBoundingBox) -> None:
        """
        setup_camera(intrinsics, extrinsic_matrix, model_bounds): sets the camera view
        """
    @typing.overload
    def setup_camera(self, arg0: numpy.ndarray, arg1: numpy.ndarray, arg2: int, arg3: int, arg4: open3d.cuda.pybind.geometry.AxisAlignedBoundingBox) -> None:
        """
