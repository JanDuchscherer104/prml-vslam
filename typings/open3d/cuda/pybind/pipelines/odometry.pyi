...
class OdometryOption:
    ...
    def __init__(
        self,
        iteration_number_per_pyramid_level: open3d.cuda.pybind.utility.IntVector = ...,
...
def compute_correspondence(
    ...
    depth_s: open3d.cuda.pybind.geometry.Image,
    depth_t: open3d.cuda.pybind.geometry.Image,
...
def compute_rgbd_odometry(
    rgbd_source: open3d.cuda.pybind.geometry.RGBDImage,
    rgbd_target: open3d.cuda.pybind.geometry.RGBDImage,
    pinhole_camera_intrinsic: open3d.cuda.pybind.camera.PinholeCameraIntrinsic = ...,
    odo_init: numpy.ndarray = ...,
    jacobian: RGBDOdometryJacobian = ...,
    option: OdometryOption = ...,
