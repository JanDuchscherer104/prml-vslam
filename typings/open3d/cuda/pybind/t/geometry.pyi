...
class AxisAlignedBoundingBox(Geometry, DrawableGeometry):
    ...
    @staticmethod
    def from_legacy(
        box: open3d.cuda.pybind.geometry.AxisAlignedBoundingBox,
        dtype: open3d.cuda.pybind.core.Dtype = ...,
    ...
    def get_point_indices_within_bounding_box(
        self, points: open3d.cuda.pybind.core.Tensor
...
class Image(Geometry):
    ...
    @staticmethod
    def from_legacy(
        image_legacy: open3d.cuda.pybind.geometry.Image, device: open3d.cuda.pybind.core.Device = ...
    ) -> Image:
        """
    ...
    @typing.overload
    def to(
        self, dtype: open3d.cuda.pybind.core.Dtype, copy: bool = False, scale: float | None = None, offset: float = 0.0
    ) -> Image:
        """
...
class InterpType:
    ...
    Cubic: typing.ClassVar[InterpType]
    Lanczos: typing.ClassVar[InterpType]
    Linear: typing.ClassVar[InterpType]
    Nearest: typing.ClassVar[InterpType]
    Super: typing.ClassVar[InterpType]
    __members__: typing.ClassVar[dict[str, InterpType]]
...
class LineSet(Geometry, DrawableGeometry):
    ...
    def create_camera_visualization(
        ...
        scale: float = 1.0,
        color: open3d.cuda.pybind.core.Tensor = ...,
    ) -> LineSet:
        """
    ...
    @staticmethod
    def from_legacy(
        lineset_legacy: open3d.cuda.pybind.geometry.LineSet,
        float_dtype: open3d.cuda.pybind.core.Dtype = ...,
        int_dtype: open3d.cuda.pybind.core.Dtype = ...,
        device: open3d.cuda.pybind.core.Device = ...,
    ) -> LineSet:
        """
    ...
    @typing.overload
    def __init__(
        self, point_positions: open3d.cuda.pybind.core.Tensor, line_indices: open3d.cuda.pybind.core.Tensor
    ) -> None:
        """
    ...
    def cuda(self, device_id: int = 0) -> LineSet:
        ...
        """
    def extrude_linear(
        self, vector: open3d.cuda.pybind.core.Tensor, scale: float = 1.0, capping: bool = True
    ) -> TriangleMesh:
        """
    ...
    def extrude_rotation(
        self,
        angle: float,
        axis: open3d.cuda.pybind.core.Tensor,
        resolution: int = 16,
...
class Metric:
    ...
    ChamferDistance: typing.ClassVar[Metric]
    FScore: typing.ClassVar[Metric]
    HausdorffDistance: typing.ClassVar[Metric]
    __members__: typing.ClassVar[dict[str, Metric]]
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class OrientedBoundingBox(Geometry, DrawableGeometry):
    ...
    @staticmethod
    def from_legacy(
        box: open3d.cuda.pybind.geometry.OrientedBoundingBox,
        dtype: open3d.cuda.pybind.core.Dtype = ...,
        device: open3d.cuda.pybind.core.Device = ...,
    ) -> OrientedBoundingBox:
        """
    ...
    def __init__(
        self,
        center: open3d.cuda.pybind.core.Tensor,
        rotation: open3d.cuda.pybind.core.Tensor,
        extent: open3d.cuda.pybind.core.Tensor,
    ) -> None:
        """
    ...
    def get_point_indices_within_bounding_box(
        ...
        """
    def rotate(
        self, rotation: open3d.cuda.pybind.core.Tensor, center: open3d.cuda.pybind.core.Tensor | None = None
    ) -> OrientedBoundingBox:
        """
...
class PointCloud(Geometry, DrawableGeometry):
    ...
    @staticmethod
    def from_legacy(
        pcd_legacy: open3d.cuda.pybind.geometry.PointCloud,
        dtype: open3d.cuda.pybind.core.Dtype = ...,
        device: open3d.cuda.pybind.core.Device = ...,
    ) -> PointCloud:
        """
    ...
    ) -> tuple[PointCloud, open3d.cuda.pybind.core.Tensor]:
        """
    ...
    def compute_convex_hull(self, joggle_inputs: bool = False) -> TriangleMesh:
        ...
        """
    def compute_metrics(
        self, pcd2: PointCloud, metrics: list[Metric], params: MetricParameters
    ) -> open3d.cuda.pybind.core.Tensor:
        """
    ...
    def hidden_point_removal(
        self, camera_location: open3d.cuda.pybind.core.Tensor, radius: float
    ) -> tuple[TriangleMesh, open3d.cuda.pybind.core.Tensor]:
        """
    ...
    def pca_partition(self, max_points: int) -> int:
        ...
        """
    def project_to_depth_image(
        self,
        width: int,
        height: int,
        intrinsics: open3d.cuda.pybind.core.Tensor,
        extrinsics: open3d.cuda.pybind.core.Tensor = ...,
    ...
    def remove_radius_outliers(
        self, nb_points: int, search_radius: float
    ) -> tuple[PointCloud, open3d.cuda.pybind.core.Tensor]:
        """
    ...
    def scale(self, scale: float, center: open3d.cuda.pybind.core.Tensor) -> PointCloud:
        ...
        """
    def segment_plane(
        self, distance_threshold: float = 0.01, ransac_n: int = 3, num_iterations: int = 100, probability: float = 0.999
        ...
        """
    def select_by_index(
        self, indices: open3d.cuda.pybind.core.Tensor, invert: bool = False, remove_duplicates: bool = False
    ) -> PointCloud:
        """
...
class RaycastingScene:
    ...
    def create_rays_pinhole(
        intrinsic_matrix: open3d.cuda.pybind.core.Tensor,
        extrinsic_matrix: open3d.cuda.pybind.core.Tensor,
        width_px: int,
        height_px: int,
    ) -> open3d.cuda.pybind.core.Tensor:
        """
    ...
    def create_rays_pinhole(
        fov_deg: float,
        center: open3d.cuda.pybind.core.Tensor,
        eye: open3d.cuda.pybind.core.Tensor,
        up: open3d.cuda.pybind.core.Tensor,
        width_px: int,
        height_px: int,
    ) -> open3d.cuda.pybind.core.Tensor:
        """
    ...
    @typing.overload
    def add_triangles(
        self, vertex_positions: open3d.cuda.pybind.core.Tensor, triangle_indices: open3d.cuda.pybind.core.Tensor
    ) -> int:
        """
    ...
    def add_triangles(self, mesh: TriangleMesh) -> int:
        ...
        """
    def cast_rays(
        self, rays: open3d.cuda.pybind.core.Tensor, nthreads: int = 0
    ) -> dict[str, open3d.cuda.pybind.core.Tensor]:
        """
    ...
    def compute_closest_points(
        self, query_points: open3d.cuda.pybind.core.Tensor, nthreads: int = 0
    ) -> dict[str, open3d.cuda.pybind.core.Tensor]:
        """
    ...
    def compute_occupancy(
        self, query_points: open3d.cuda.pybind.core.Tensor, nthreads: int = 0, nsamples: int = 1
    ) -> open3d.cuda.pybind.core.Tensor:
        """
    ...
    def list_intersections(
        ...
        """
    def test_occlusions(
        self, rays: open3d.cuda.pybind.core.Tensor, tnear: float = 0.0, tfar: float = ..., nthreads: int = 0
    ) -> open3d.cuda.pybind.core.Tensor:
        """
...
class TriangleMesh(Geometry, DrawableGeometry):
    ...
    def create_isosurfaces(
        volume: open3d.cuda.pybind.core.Tensor,
        contour_values: list[float] = [0.0],
        device: open3d.cuda.pybind.core.Device = ...,
    ) -> TriangleMesh:
        """
    ...
    @staticmethod
    def from_legacy(
        mesh_legacy: open3d.cuda.pybind.geometry.TriangleMesh,
        vertex_dtype: open3d.cuda.pybind.core.Dtype = ...,
        triangle_dtype: open3d.cuda.pybind.core.Dtype = ...,
        device: open3d.cuda.pybind.core.Device = ...,
    ) -> TriangleMesh:
        """
        ...
        """
    @staticmethod
    def from_triangle_mesh_model(
        model: open3d.cuda.pybind.visualization.rendering.TriangleMeshModel,
        vertex_dtype: open3d.cuda.pybind.core.Dtype = ...,
        triangle_dtype: open3d.cuda.pybind.core.Dtype = ...,
        device: open3d.cuda.pybind.core.Device = ...,
    ...
    def bake_triangle_attr_textures(
        self, size: int, triangle_attr: set[str], margin: float = 2.0, fill: float = 0.0, update_material: bool = True
    ) -> dict[str, open3d.cuda.pybind.core.Tensor]:
        """
    ...
    def bake_vertex_attr_textures(
        self, size: int, vertex_attr: set[str], margin: float = 2.0, fill: float = 0.0, update_material: bool = True
    ) -> dict[str, open3d.cuda.pybind.core.Tensor]:
        """
    ...
    def compute_convex_hull(self, joggle_inputs: bool = False) -> TriangleMesh:
        ...
        """
    def compute_metrics(
        self, mesh2: TriangleMesh, metrics: list[Metric], params: MetricParameters
    ) -> open3d.cuda.pybind.core.Tensor:
        """
    ...
    def pca_partition(self, max_faces: int) -> int:
        ...
        """
    def project_images_to_albedo(
        self,
        images: list[Image],
        intrinsic_matrices: list[open3d.cuda.pybind.core.Tensor],
        extrinsic_matrices: list[open3d.cuda.pybind.core.Tensor],
        tex_size: int = 1024,
    ...
    def slice_plane(
        self,
        point: open3d.cuda.pybind.core.Tensor,
        normal: open3d.cuda.pybind.core.Tensor,
        contour_values: list[float] = [0.0],
    ) -> LineSet:
        """
...
class VoxelBlockGrid:
    ...
    def __init__(
        self,
        attr_names: list[str],
        attr_dtypes: list[open3d.cuda.pybind.core.Dtype],
        attr_channels: list[open3d.cuda.pybind.core.SizeVector],
    ...
    def integrate(
        self,
        block_coords: open3d.cuda.pybind.core.Tensor,
        depth: Image,
        color: Image,
        depth_intrinsic: open3d.cuda.pybind.core.Tensor,
    ...
    def ray_cast(
        ...
        width: int,
        height: int,
        render_attributes: list[str] = ["depth", "color"],
        depth_scale: float = 1000.0,
    ...
    def voxel_coordinates_and_flattened_indices(
        self, buf_indices: open3d.cuda.pybind.core.Tensor
    ) -> tuple[open3d.cuda.pybind.core.Tensor, open3d.cuda.pybind.core.Tensor]:
        """
