...
class DepthNoiseSimulator:
    ...
    def enable_deterministic_debug_mode(self) -> None:
        ...
        """
    def simulate(
        self, im_src: open3d.cuda.pybind.t.geometry.Image, depth_scale: float = 1000.0
...
class RealSenseSensor(RGBDSensor):
    ...
    def __repr__(self) -> str: ...
    def capture_frame(
        self, wait: bool = True, align_depth_to_color: bool = True
    ...
    @typing.overload
    def init_sensor(
        self, sensor_config: RealSenseSensorConfig = ..., sensor_index: int = 0, filename: str = ""
    ) -> bool:
        """
            Configure sensor with custom settings. If this is skipped, default settings will be used. You can enable recording to a bag file by specifying a filename.
...
def write_point_cloud(
    filename: os.PathLike,
    pointcloud: open3d.cuda.pybind.t.geometry.PointCloud,
