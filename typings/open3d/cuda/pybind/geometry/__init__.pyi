...
class KDTreeFlann:
    ...
    def search_hybrid_vector_3d(
        self, query: numpy.ndarray, radius: float, max_nn: int
    ...
    def search_knn_vector_3d(
        self, query: numpy.ndarray, knn: int
    ) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
            query (numpy.ndarray[numpy.float64[3, 1]]): The input query point.
    ...
    def search_radius_vector_3d(
        self, query: numpy.ndarray, radius: float
    ) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
            query (numpy.ndarray[numpy.float64[3, 1]]): The input query point.
    ...
    def search_vector_3d(
        self, query: numpy.ndarray, search_param: KDTreeSearchParam
    ) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
            query (numpy.ndarray[numpy.float64[3, 1]]): The input query point.
...
class LineSet(Geometry3D):
    ...
    def create_camera_visualization(
        view_width_px: int, view_height_px: int, intrinsic: numpy.ndarray, extrinsic: numpy.ndarray, scale: float = 1.0
    ) -> LineSet:
        """
    ...
    @typing.overload
    def create_camera_visualization(
        intrinsic: open3d.cuda.pybind.camera.PinholeCameraIntrinsic, extrinsic: numpy.ndarray, scale: float = 1.0
    ) -> LineSet:
        """
        Factory function to create a LineSet from intrinsic and extrinsic camera matrices
        """
    ...
    def create_from_point_cloud_correspondences(
        cloud0: PointCloud, cloud1: PointCloud, correspondences: list[tuple[int, int]]
    ) -> LineSet:
        """
    ...
    @typing.overload
    def __init__(
        self, points: open3d.cuda.pybind.utility.Vector3dVector, lines: open3d.cuda.pybind.utility.Vector2iVector
    ) -> None:
        """
...
class Octree(Geometry3D):
    ...
    def insert_point(
        self,
        point: numpy.ndarray,
        f_init: typing.Callable[[], OctreeLeafNode],
        f_update: typing.Callable[[OctreeLeafNode], None],
        fi_init: typing.Callable[[], OctreeInternalNode] = None,
        fi_update: typing.Callable[[OctreeInternalNode], None] = None,
    ) -> None:
        """
...
class OrientedBoundingBox(Geometry3D):
    ...
    def create_from_points(
        points: open3d.cuda.pybind.utility.Vector3dVector, robust: bool = False
    ) -> OrientedBoundingBox:
        """
        ...
        """
    @staticmethod
    def create_from_points_minimal(
        points: open3d.cuda.pybind.utility.Vector3dVector, robust: bool = False
    ) -> OrientedBoundingBox:
        """
        Creates the oriented bounding box with the smallest volume.
...
class PointCloud(Geometry3D):
    ...
    def create_from_depth_image(
        depth: Image,
        intrinsic: open3d.cuda.pybind.camera.PinholeCameraIntrinsic,
    ...
    def estimate_point_covariances(
        input: PointCloud, search_param: KDTreeSearchParam = ...
    ...
    def orient_normals_consistent_tangent_plane(
        self, k: int, lambda_penalty: float = 0.0, cos_alpha_tol: float = 1.0
    ) -> None:
        """
    ...
    def remove_radius_outlier(
        self, nb_points: int, radius: float, print_progress: bool = False
    ...
    def remove_statistical_outlier(
        self, nb_neighbors: int, std_ratio: float, print_progress: bool = False
    ) -> tuple[PointCloud, list[int]]:
        """
        ...
        """
    def segment_plane(
        self, distance_threshold: float, ransac_n: int, num_iterations: int, probability: float = 0.99999999
    ...
    def voxel_down_sample_and_trace(
        self, voxel_size: float, min_bound: numpy.ndarray, max_bound: numpy.ndarray, approximate_class: bool = False
    ) -> tuple[PointCloud, numpy.ndarray, list[open3d.cuda.pybind.utility.IntVector]]:
        """
...
class TetraMesh(MeshBase):
    ...
    @typing.overload
    def __init__(
        self, vertices: open3d.cuda.pybind.utility.Vector3dVector, tetras: open3d.cuda.pybind.utility.Vector4iVector
    ) -> None:
        """
...
class TriangleMesh(MeshBase):
    ...
    def create_box(
        ...
        map_texture_to_each_face: bool = False,
    ) -> TriangleMesh:
        """
    ...
    @staticmethod
    def create_cone(
        radius: float = 1.0, height: float = 2.0, resolution: int = 20, split: int = 1, create_uv_map: bool = False
    ) -> TriangleMesh:
        """
    ...
    @staticmethod
    def create_cylinder(
        radius: float = 1.0, height: float = 2.0, resolution: int = 20, split: int = 4, create_uv_map: bool = False
    ) -> TriangleMesh:
        """
    ...
    def create_from_oriented_bounding_box(
        obox: OrientedBoundingBox, scale: numpy.ndarray = ..., create_uv_map: bool = False
    ) -> TriangleMesh:
        """
    ...
    def create_from_point_cloud_alpha_shape(
        pcd: PointCloud, alpha: float, tetra_mesh: TetraMesh, pt_map: list[int]
    ) -> TriangleMesh:
        """
    ...
    def create_from_point_cloud_ball_pivoting(
        pcd: PointCloud, radii: open3d.cuda.pybind.utility.DoubleVector
    ) -> TriangleMesh:
        """
    ...
    def create_from_point_cloud_poisson(
        ...
        n_threads: int = -1,
    ) -> tuple[TriangleMesh, open3d.cuda.pybind.utility.DoubleVector]:
        """
    ...
    @staticmethod
    def create_torus(
        torus_radius: float = 1.0, tube_radius: float = 0.5, radial_resolution: int = 30, tubular_resolution: int = 20
    ) -> TriangleMesh:
        """
    ...
    @typing.overload
    def __init__(
        self, vertices: open3d.cuda.pybind.utility.Vector3dVector, triangles: open3d.cuda.pybind.utility.Vector3iVector
    ) -> None:
        """
    ...
    def deform_as_rigid_as_possible(
        self,
        constraint_vertex_indices: open3d.cuda.pybind.utility.IntVector,
        constraint_vertex_positions: open3d.cuda.pybind.utility.Vector3dVector,
        max_iter: int,
        energy: DeformAsRigidAsPossibleEnergy = ...,
    ...
    def euler_poincare_characteristic(self) -> int:
        ...
        """
    def filter_sharpen(
        self, number_of_iterations: int = 1, strength: float = 1, filter_scope: FilterScope = ...
    ) -> TriangleMesh:
        """
    ...
    def filter_smooth_laplacian(
        self, number_of_iterations: int = 1, lambda_filter: float = 0.5, filter_scope: FilterScope = ...
    ) -> TriangleMesh:
        """
    ...
    def sample_points_poisson_disk(
        self, number_of_points: int, init_factor: float = 5, pcl: PointCloud = None, use_triangle_normal: bool = False
    ) -> PointCloud:
        """
    ...
    def simplify_quadric_decimation(
        self, target_number_of_triangles: int, maximum_error: float = ..., boundary_weight: float = 1.0
    ) -> TriangleMesh:
        """
    ...
    def simplify_vertex_clustering(
        self, voxel_size: float, contraction: SimplificationContraction = ...
    ) -> TriangleMesh:
        """
...
class VoxelGrid(Geometry3D):
    ...
    @staticmethod
    def create_dense(
        origin: numpy.ndarray, color: numpy.ndarray, voxel_size: float, width: float, height: float, depth: float
    ) -> VoxelGrid:
        """
    ...
    def create_from_point_cloud(
        input: PointCloud, voxel_size: float, pooling_mode: VoxelGrid.VoxelPoolingMode = ...
    ) -> VoxelGrid:
        """
    ...
    def create_from_point_cloud_within_bounds(
        input: PointCloud,
        voxel_size: float,
        min_bound: numpy.ndarray,
        max_bound: numpy.ndarray,
        pooling_mode: VoxelGrid.VoxelPoolingMode = ...,
    ) -> VoxelGrid:
        """
    ...
    def create_from_triangle_mesh_within_bounds(
        input: TriangleMesh, voxel_size: float, min_bound: numpy.ndarray, max_bound: numpy.ndarray
    ) -> VoxelGrid:
        """
    ...
    def carve_depth_map(
        ...
        keep_voxels_outside_image: bool = False,
    ) -> VoxelGrid:
        """
