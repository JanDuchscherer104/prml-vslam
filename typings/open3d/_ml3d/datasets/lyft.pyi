...
import typing
import yaml as yaml
__all__: list[str] = ['BEVBox3D', 'BaseDataset', 'Config', 'DATASET', 'Lyft', 'LyftSplit', 'Path', 'R', 'abspath', 'argparse', 'dirname', 'exists', 'glob', 'isfile', 'join', 'log', 'logging', 'make_dir', 'np', 'os', 'pickle', 'split', 'sys', 'yaml']
class Lyft(open3d._ml3d.datasets.base_dataset.BaseDataset):
    """
    ...
    def save_test_result():
        ...
        """
    def __init__(self, dataset_path, info_path = None, name = 'Lyft', cache_dir = './logs/cache', use_cache = False, **kwargs):
        """
