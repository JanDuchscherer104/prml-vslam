...
import typing
__all__: list[str] = ['BaseDataset', 'BaseDatasetSplit', 'Custom3D', 'Custom3DSplit', 'DATASET', 'KDTree', 'Path', 'abspath', 'dirname', 'exists', 'glob', 'join', 'log', 'logging', 'make_dir', 'np', 'os', 'pickle', 'sys', 'tqdm']
class Custom3D(open3d._ml3d.datasets.base_dataset.BaseDataset):
    """
    ...
    def get_label_to_names():
        ...
        """
    def __init__(self, dataset_path, name = 'Custom3D', cache_dir = './logs/cache', use_cache = False, num_points = 65536, ignored_label_inds = list(), test_result_folder = './test', **kwargs):
        ...
    ...
    def save_test_result(self, results, attr):
        ...
        """
class Custom3DSplit(open3d._ml3d.datasets.base_dataset.BaseDatasetSplit):
    """
