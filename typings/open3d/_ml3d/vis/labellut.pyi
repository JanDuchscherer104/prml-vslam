...
__all__: list[str] = ["LabelLUT", "rgb_to_yiq"]
...
class LabelLUT:
    ...
    Colors: typing.ClassVar[list] = [
        ...
        [1.0, 0.0, 0.0],
        [0.11764706, 0.11764706, 1.0],
        [0.78431373, 0.15686275, 1.0],
        [0.35294118, 0.11764706, 0.58823529],
        [1.0, 0.0, 1.0],
        [1.0, 0.58823529, 1.0],
        [0.29411765, 0.0, 0.29411765],
        [0.29411765, 0.0, 0.68627451],
        [0.0, 0.78431373, 1.0],
        [0.19607843, 0.47058824, 1.0],
        [0.0, 0.68627451, 0.0],
        [0.0, 0.23529412, 0.52941176],
        [0.31372549, 0.94117647, 0.58823529],
        [0.58823529, 0.94117647, 1.0],
        [0.0, 0.0, 1.0],
        [1.0, 1.0, 0.25],
        [0.5, 1.0, 0.25],
        [0.25, 1.0, 0.25],
